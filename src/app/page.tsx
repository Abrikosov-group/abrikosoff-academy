...
const included = [
  ...
  {
    title: "Прогресс и продолжение",
    text: "вернётесь туда, где остановились.",
  },
  {
    title: "Отмена в один клик",
    text: "доступ до конца оплаченного периода.",
  },
];
      ...
      <section className="home-pricing page-shell" aria-labelledby="home-pricing">
        <div>
          ...
          <p>
            ...
            1 500 ₽. Продление отключается в один клик; доступ сохраняется до
