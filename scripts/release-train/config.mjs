...
export const INFRASTRUCTURE_NO_DEPLOY_PATHS = Object.freeze(
  new Set([
    ...
    "docs/design/admin-student-card-v2.md",
    "docs/development-workflow.md",
    "docs/operations/local-public-development.md",
    "docs/operations/release-train.md",
    "infra/github-runners/abrikosoff-academy-review/README.md",
    ...
    "infra/github-runners/abrikosoff-academy-review/install.sh",
    "infra/github-runners/abrikosoff-academy-review/orchestration-runner-override.conf",
    "infra/github-runners/abrikosoff-academy-review/verify-job.sh",
    ...
    "tests/unit/organizational-review-workflow.test.ts",
  ]),
);
